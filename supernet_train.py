...
from utils import AverageMeter, set_seeds, setup_logger, calc_params, accuracy, reduce_tensor, \
    bn_recalc, save_checkpoint
...
parser = argparse.ArgumentParser('supernet-training')
...
parser.add_argument('--total-epochs', type=int, default=120, help='total epochs')
...
parser.add_argument('--exp-dir', type=str, default='supernet_train_exp', help='experiment directory')
...
def main():
    ...
    train_loader = create_loader(args.train_path, args.batch_size, use_gpu, args.distributed, is_training=True)
    ...
    if args.eval_only:
        try:
            ...
            if args.local_rank == 0:
                ...
                logging.info('Recalc batchnorm statistics')
