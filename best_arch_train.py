...
parser.add_argument('--best_arch', type=list, default=[2, 2, 3, 0, 2, 0, 2, 1, 2, 2, 2, 1, 3, 1, 1, 3, 2, 0, 1, 1],
                    help='best architecture')

parser.add_argument('--start_epoch', type=int, default=1, help='start epoch (default is 1)')
parser.add_argument('--total_epochs', type=int, default=360, help='total epochs')
...
parser.add_argument('--keep_num', type=int, default=10, help='max ckpt num to keep')
...
parser.add_argument('--sched_type', type=str, default='cosine', help='lr scheduler type')
...
parser.add_argument('--train_path', type=str, default='/home/wangguangrun/ILSVRC2012/train', help='path to train dataset')
parser.add_argument('--val_path', type=str, default='/home/wangguangrun/ILSVRC2012/val', help='path to val dataset')
...
def main():
    ...
    train_loader = create_dataset(args.train_path, args.batch_size, use_gpu, args.distributed, is_training=True)
    val_loader = create_dataset(args.val_path, args.batch_size, use_gpu, args.distributed)
    ...
    if args.eval_only:
        try:
            ...
            validate(model, val_loader, use_gpu)
